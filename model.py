...
L = len(n)
weights_file = './mnist_classifier/mnist_trained_weights_deep.dat'
...
def gradient_descent(W, b, n_epochs = 2000, batch_size = 2**8, keep_prob = 1., lbd = 0., learning_rate = .002, beta1 = .9, beta2 = .999, decay_rate = 1.):
    VdW, Vdb = init_adam()
    SdW, Sdb = init_adam()
